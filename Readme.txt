...
1. Install the Package:
   - Use apt to install it:
     sudo apt install ./sml-screensaver_xxxx.deb

3. Initialize Environment:
   - Launch "WinScreensaver" from your KDE Application Menu.
   - The first run will automatically trigger the setup.
...
Change log:
 ...
 -V2.3    29-01-2026: Added support for Wayland
 -V3.0    30-01-2026: Implemented Debian Builder, global icon registration, fixed root-permission issues,
                      and hardcoded absolute paths for reliable service autostart.
